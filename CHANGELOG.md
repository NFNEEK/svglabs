...
* add missing files for commitzen ([018ba8b](https://github.com/NFNEEK/svglabs/commit/018ba8bde81b0f6cc60230fe4668b149ac3b2e6a))
* add npx before percy command line ([4824e98](https://github.com/NFNEEK/svglabs/commit/4824e98a4d621684494fe2c7e8c3351551e52845))
* add sitemap file in gitignore, it shouldn't commit to git ([344b731](https://github.com/NFNEEK/svglabs/commit/344b7312df2f7e12e642a6346ef05ad9a7ca766c))
* add steps in update-deps.yml file, syntax error ([b5de445](https://github.com/NFNEEK/svglabs/commit/b5de445f1f927a5a7c2b0c85746b8fd07629cb55))
* added types ([b35ddc9](https://github.com/NFNEEK/svglabs/commit/b35ddc91ecad81986432dce1ba84c302e6394a5b))
* api routes not found after apply intl middleware ([4650a5e](https://github.com/NFNEEK/svglabs/commit/4650a5e293716dee7704c6082839aaf94b63e7ad)), closes [#209](https://github.com/NFNEEK/svglabs/issues/209)
* build issues with prerendering ([ff117b9](https://github.com/NFNEEK/svglabs/commit/ff117b9750e3609cebbf53a5dea01f0fbf94f865))
* change matching regex for Cypress files ([861d545](https://github.com/NFNEEK/svglabs/commit/861d54596b61b7706cfbb681df334d73b34a378e))
* code styling in blog component pages ([f4a55c4](https://github.com/NFNEEK/svglabs/commit/f4a55c4234fc03ed719859c12f13bffabd120c6d))
* error generated by eslint-plugin-cypress ([7562c6b](https://github.com/NFNEEK/svglabs/commit/7562c6bddb31e6941aee7e4e2bbcdabf5be3bddf))
* Eslint comment update ([8baa5d1](https://github.com/NFNEEK/svglabs/commit/8baa5d160734a3cadb419534509cc6edaac57456))
* just rebuild sitemap ([831bae9](https://github.com/NFNEEK/svglabs/commit/831bae93831eb5c4f259c4a0fa9ec3012ede8927))
* move getStaticPaths at the top of blog page ([83892ea](https://github.com/NFNEEK/svglabs/commit/83892ea865459f59da824c9358fbf4ccea6475e6))
* remove generated files by next-sitemap ([c5d93bf](https://github.com/NFNEEK/svglabs/commit/c5d93bf9fe67a6737b536edf4d50d56cd4c8af2c))
* rename from mjs to js next-sitemap file ([7d450ff](https://github.com/NFNEEK/svglabs/commit/7d450ffce77f0be4c533cb1aab757f7fb1f13596))
* resolve merge conflict ([276f57a](https://github.com/NFNEEK/svglabs/commit/276f57aeb0d4a346f8e19ad81ce4703458d9f41c))
* resolve sourcemap error with Cypress and TypeScript 5 ([54a5100](https://github.com/NFNEEK/svglabs/commit/54a51004d6e22860eb1c6aad4ff689fac46bd0b4))
* retrive PERCY_TOKEN and set token for percy cli ([afe00f2](https://github.com/NFNEEK/svglabs/commit/afe00f2e47b5dbc5fb701dd2e46756f4b7e498fd))
* typo in en.json file for Portfolio word ([4d42b3d](https://github.com/NFNEEK/svglabs/commit/4d42b3d11feeb1134961c0c688a6659b5e88364e))
* typo in Readme ([8f7c1b7](https://github.com/NFNEEK/svglabs/commit/8f7c1b79a46406b04b90ed8a5fe5029b3c24ff8c))
* update package-lock.json ([fba016d](https://github.com/NFNEEK/svglabs/commit/fba016dec202d5748e30804b1bf50e30c00ef120))
* update README file for next-sitemap ([9496217](https://github.com/NFNEEK/svglabs/commit/94962171a35a07e84319374500f28a76f264a266))
* use npx npm-check-updates ([e530193](https://github.com/NFNEEK/svglabs/commit/e5301939a5ff98c598899ff49bee1ad351759292))
* wait until the link rendered instead a wrong heading tag ([e38655b](https://github.com/NFNEEK/svglabs/commit/e38655b853b39fdcb9bccd3a84e99dd5caa1681d))


### Features

* add .env file for production ([58ed68c](https://github.com/NFNEEK/svglabs/commit/58ed68cc2eefb1274e6e268c40a3ed8cd7d936be))
* add a new GitHub Actions file for Checkly ([2109b1c](https://github.com/NFNEEK/svglabs/commit/2109b1c75359a9ce89c2c0773fd65e78e1439403))
* add app routed pages ([9cc79a0](https://github.com/NFNEEK/svglabs/commit/9cc79a00647b0a4ce64f66da4a430ec2c4972367)), closes [#64](https://github.com/NFNEEK/svglabs/issues/64)
* add aria-label to fix jsx-a11y/control-has-associated-label error ([47e4ff4](https://github.com/NFNEEK/svglabs/commit/47e4ff4f811b4e2071b9ba31f5c0ad1367b0caba))
* add authToken support for production Turso ([26b8276](https://github.com/NFNEEK/svglabs/commit/26b827618199f1dd73453c7ec021c13a4aaf5f7b))
* add auto-update GitHub Actions ([364168f](https://github.com/NFNEEK/svglabs/commit/364168f3407c7cdd21da7cd1de6d9d930f89d99a))
* add await for migrate function ([96793f0](https://github.com/NFNEEK/svglabs/commit/96793f0adedb10f802dfb46ff96b85f14c78ebf3))
* add blog page ([89c4ec7](https://github.com/NFNEEK/svglabs/commit/89c4ec79db48f4ae09af3e8ddb3ce5a980ed8ee6))
* add code coverage reporting with Codecov ([08abd23](https://github.com/NFNEEK/svglabs/commit/08abd23acbb5fb770046900901a367d60f18695e))
* add commit script in package.json ([8f4719e](https://github.com/NFNEEK/svglabs/commit/8f4719ec550ab0dbffa93ca1d278aa9e370a773a))
* add commitlint with config-conventional ([97a9ac7](https://github.com/NFNEEK/svglabs/commit/97a9ac7dbbca3f8d4fad22a9e4a481c029cd2cb5))
* add coverage for vscode-jest and configure jest autoRun ([ad8a030](https://github.com/NFNEEK/svglabs/commit/ad8a03019010577bfb8e8ed850e8d45ca274dbe9))
* add cypress and cypress eslint plugin ([5657ee6](https://github.com/NFNEEK/svglabs/commit/5657ee6dab03b11020bb2ce80083669785edd6ce))
* add database powered by Turso in guestbook page ([64073a5](https://github.com/NFNEEK/svglabs/commit/64073a5babb38327a23fd3ae2b354152306e7977))
* add db file in gitignore ([cd45e09](https://github.com/NFNEEK/svglabs/commit/cd45e0906cc79e87302ee6b88674089c5de059a3))
* add drizzle config and database schema ([df30388](https://github.com/NFNEEK/svglabs/commit/df30388002ead9121ffb764e1bd11a71550cbe06))
* add email alert channel for checkly ([d1a4380](https://github.com/NFNEEK/svglabs/commit/d1a43801d64fa261bdb252cf83dc289742f37294))
* add email channel in Checkly configuration to send emails when failing ([2019591](https://github.com/NFNEEK/svglabs/commit/20195919d8a07f4e3cc0b7884e7d972de2935a94))
* add environment variables for one click deploy Netlify ([5becdbf](https://github.com/NFNEEK/svglabs/commit/5becdbf59f43fdfe893c5b7b62cac1246787a07e))
* add FIXME tag for Sentry configuration ([2eceef1](https://github.com/NFNEEK/svglabs/commit/2eceef14257232c89f625acfe475c1aa7f220e46))
* add GitHub Actions to sync with Crowdin ([ccc86e9](https://github.com/NFNEEK/svglabs/commit/ccc86e9e4df89dadd3214ae167972038f44108a6))
* add i18n support for client component and typesafety for i18n keys ([2d86247](https://github.com/NFNEEK/svglabs/commit/2d862478414c4e6cf06e287acbef50369ef9a119))
* add i18n support for Dashboard url used in Clerk ([12b89bc](https://github.com/NFNEEK/svglabs/commit/12b89bcfa1cae76872fc1504960a5ee417ef5eea))
* add i18n with Clerk components and remove custom style in global.css file ([5e1af6c](https://github.com/NFNEEK/svglabs/commit/5e1af6c9a83cc6988c68fd761bf4945a2e0cdb9c))
* add i18n with next-intl ([1f43eb2](https://github.com/NFNEEK/svglabs/commit/1f43eb247ad8591fef3aa8a34d112dd804eec4c3))
* add locale switcher UI to change lang ([13b40e3](https://github.com/NFNEEK/svglabs/commit/13b40e32d265d341da1cf723c1af36f3ea53e7e1))
* add metatags in App Router for page migrated from Pages Router ([ce8c277](https://github.com/NFNEEK/svglabs/commit/ce8c2770c41abcc3c866d7320de6ef4d8a541715))
* add next.js middleware with Clerk ([2f4a1d3](https://github.com/NFNEEK/svglabs/commit/2f4a1d3e394eb835b011a13289f156a91993d782))
* add pino.js as Logger ([1d35f43](https://github.com/NFNEEK/svglabs/commit/1d35f43efd5e250498d2d30654be672e4e2d91c9))
* add playwright extension in VSCode ([956d1a8](https://github.com/NFNEEK/svglabs/commit/956d1a8ec70c6a1214c72a115f0378507aa1b436))
* add playwright plugin in ESLint ([b2486f1](https://github.com/NFNEEK/svglabs/commit/b2486f1b1090c458115b873ddc5bffa8ecaf8412))
* add Playwright: config, first test and dependency ([f054ea2](https://github.com/NFNEEK/svglabs/commit/f054ea264bab3376ab7f86b0a0fdc1b6a4e98350))
* add preferType on VSCode ([a55bc6a](https://github.com/NFNEEK/svglabs/commit/a55bc6a4b543c47ec491c5a84806f62c93dc1aa4))
* add PRODUCTION_URL environment variable and throw error when targetURL doesn't exist ([8134dee](https://github.com/NFNEEK/svglabs/commit/8134dee84205e297020851bad4c81cf3906e7dfe))
* add schema in drizzle instance and disable migrate in production ([5e26798](https://github.com/NFNEEK/svglabs/commit/5e2679877a3da64a4cabfc22fdaacebd6abe6789))
* add script to migrate before building next.js ([220d05e](https://github.com/NFNEEK/svglabs/commit/220d05e5d028852ccc533ca60b187bc3d47c5d73))
* add Sentry and launch spotlight.js in dev mode ([a1326ae](https://github.com/NFNEEK/svglabs/commit/a1326aebb4ade33dc8a4429e749fb482ed906754))
* add sign in and sign up link in index page ([4489085](https://github.com/NFNEEK/svglabs/commit/4489085e8deb0ae1836a3741657f8331af6294ca))
* add sign in and sign up page ([f021f71](https://github.com/NFNEEK/svglabs/commit/f021f71f755e3af3cb789d0330ad2a0237ec600d))
* add sign out button in dashboard ([c663d1c](https://github.com/NFNEEK/svglabs/commit/c663d1c4799869faf2a2c549669521409f192830))
* add sitemap support app router ([b82e566](https://github.com/NFNEEK/svglabs/commit/b82e566fb43d63329ef4507870494e554dea0e6a))
* add sitemap.xml and robots.txt from build ([545d133](https://github.com/NFNEEK/svglabs/commit/545d133decee4f7d42c228049ef3bde2b9a94b0a))
* add spotlight ([34086c1](https://github.com/NFNEEK/svglabs/commit/34086c1b8636bdc391c31ceed062a1e858d81539))
* add storybook into project ([51f3748](https://github.com/NFNEEK/svglabs/commit/51f3748c0cb6d9cd04cdb0d3b9d95a0f60851866))
* add style for guestbook ([339154c](https://github.com/NFNEEK/svglabs/commit/339154ccfdaf7e53aeefd12fe0e347c645be5163))
* add support i18n for authMiddleware ([8651d36](https://github.com/NFNEEK/svglabs/commit/8651d36279512b0f5e008341916110a8ee6f167a))
* add tailwind css support in Storybook ([5e0d287](https://github.com/NFNEEK/svglabs/commit/5e0d287cef8a898df8f1a98632a8703657282100))
* add target blank for links going outside ([37ba36e](https://github.com/NFNEEK/svglabs/commit/37ba36e5e3815d87cf882dc9aaf8b69b5849b49e))
* add tests for page in App Router ([6a722a1](https://github.com/NFNEEK/svglabs/commit/6a722a1fec7a236973f794edc6583a245ebb4747))
* add type definition in Postcss config ([07906ff](https://github.com/NFNEEK/svglabs/commit/07906ff20a7c8d2b0c24cc1f33c93b0bc541b9c3))
* add typesafe environment variables ([5a2cd78](https://github.com/NFNEEK/svglabs/commit/5a2cd78aca2fc60e6c0d4861ff656e7ba2ac86c4))
* add TypeScript support for Tailwind CSS configuration ([41f1918](https://github.com/NFNEEK/svglabs/commit/41f19189655abe3941485363e057812a5fcd6c02))
* add user profile to manage account ([470731b](https://github.com/NFNEEK/svglabs/commit/470731ba960dfdd0aa57f66affde28b0226d5d42))
* add user profile to manage account ([581efbe](https://github.com/NFNEEK/svglabs/commit/581efbef51cf700f9bbe94f268ff99639f5e49da))
* add visual testing with Percy ([b0a39f5](https://github.com/NFNEEK/svglabs/commit/b0a39f58e1bd0934158b0bab8ab7e4c9215e88f0))
* add vscode jest extension ([49ab935](https://github.com/NFNEEK/svglabs/commit/49ab935a03f5a9d1074a155331107737fd7dad13))
* add vscode yoavbls.pretty-ts-errors extension ([3588ce1](https://github.com/NFNEEK/svglabs/commit/3588ce1dd366ebaa69f97551be58528d1ae38457))
* app router doesn't support next export, use output: export ([76aa9cd](https://github.com/NFNEEK/svglabs/commit/76aa9cd0597ad06fd0f0160ad6119a25b87d3336))
* automatically format the whole codebase with npm run format ([9299209](https://github.com/NFNEEK/svglabs/commit/92992096ede4d2b3e77c3e0c96b75e5e6b84067d))
* automatically run migrate in DB instead of running in NPM scripts ([b202686](https://github.com/NFNEEK/svglabs/commit/b202686687a41eb38cf92a0451f03b5f0a854a2d))
* change 'powered by' text to 'built' with ([fe0a29f](https://github.com/NFNEEK/svglabs/commit/fe0a29f8fbab14c7e8c8e98a75ce488ac157e509))
* change commitlint config from JS to TS ([6509805](https://github.com/NFNEEK/svglabs/commit/650980539eb16c4ef0f5d1ed3e833cdb08faaf86))
* change jest config extension from js to TypeScript ([1cdea44](https://github.com/NFNEEK/svglabs/commit/1cdea44c2a193e9df792dc997f6aa5304e043ff6))
* change nodeResolution to the new bundler from TypeScript 5.0 ([59282a2](https://github.com/NFNEEK/svglabs/commit/59282a2f028a10b841f4af42248e4ecd2c41c080))
* convert all hard coded text and translate in french ([0c3b1b2](https://github.com/NFNEEK/svglabs/commit/0c3b1b2f9a8ae5c0d34cb6f3a227a907aca00342))
* convert Tailwind config file from JS to TS ([aff3b27](https://github.com/NFNEEK/svglabs/commit/aff3b276c6b857570c3ec0b68de3cd5efaaeebbd))
* create checkly config with a random working test ([32255b0](https://github.com/NFNEEK/svglabs/commit/32255b0770ec5be84e9fd3321154329c556aedee))
* create guestbook should not accept empty username and email ([37e4408](https://github.com/NFNEEK/svglabs/commit/37e4408f968b36332a0a8ae9a90c687eee7fb4a0))
* disable Husky for release ([f20c595](https://github.com/NFNEEK/svglabs/commit/f20c5951e018c99421e833eef6ce14bd9632838f))
* do not run db migration when building on GitHub actions ([964cfa1](https://github.com/NFNEEK/svglabs/commit/964cfa1a02fb41b387c851f0b2293c673859d60a))
* e2e tests run against next start with production code ([a57f724](https://github.com/NFNEEK/svglabs/commit/a57f72402c459b75aec65472db7030557974643b))
* enable Sentry Spotlight only in development mode ([62cc01a](https://github.com/NFNEEK/svglabs/commit/62cc01ab2e1ae5594a4b91f931f313a904ff4b7d))
* enable SWC compiler in Storybook ([5b4c61e](https://github.com/NFNEEK/svglabs/commit/5b4c61ea11164b6e5853cefe363d2d433cda374d))
* fix heading levels increase by one ([e712e60](https://github.com/NFNEEK/svglabs/commit/e712e60402f04033673d93e464d7b3c46fff7dbe))
* format code to respect prettier ([48b6a49](https://github.com/NFNEEK/svglabs/commit/48b6a49fd204083deb94b01aab70b52a42b9593f))
* generate statically portfolio pages ([1f1bf31](https://github.com/NFNEEK/svglabs/commit/1f1bf3143215ab19d19cd4f13e4048b0ee84073c))
* i18n for page metatag ([5e7676d](https://github.com/NFNEEK/svglabs/commit/5e7676de0d58238de1d46e662c3c8e6e00bd2c5b))
* ignore technical exception throw by React RSC in Sentry ([4bf9503](https://github.com/NFNEEK/svglabs/commit/4bf95038600a28ea3e98e84dabec4df5fd9af609))
* implement AddGuestbookForm to create new guestbook message ([d7b37e6](https://github.com/NFNEEK/svglabs/commit/d7b37e63f65d528e599b14d64cbf3ac5b2d3feba))
* implement delete guestbook entry ([b7f823a](https://github.com/NFNEEK/svglabs/commit/b7f823a83435856ac32aea90da8317926e5b2b8b))
* implement hello component by display user email address ([7047985](https://github.com/NFNEEK/svglabs/commit/7047985ffbce9a986e7308040928783395cf7b68))
* implement sign out button ([8588834](https://github.com/NFNEEK/svglabs/commit/8588834b5f1a53c51835d7aba5a4c9f1230c1bf7))
* implement sign out button and redirect to sign in page when logging out ([45ed137](https://github.com/NFNEEK/svglabs/commit/45ed137d5c4e292ac8329f0661cb38fc29812927))
* improve accessibility ([aa0f0b1](https://github.com/NFNEEK/svglabs/commit/aa0f0b12085e31f13574fc9f4349157102d4467b))
* improve UI for AddGuestbookForm ([153abfc](https://github.com/NFNEEK/svglabs/commit/153abfc0e2f10a5aa59e24af8f0ef76667041578))
* in global error get locale in params and set in html lang attribute ([c3b4d25](https://github.com/NFNEEK/svglabs/commit/c3b4d25d3be6a5ceed48f2d365bd14e44ff9b114))
* insert in guestbook and retrieve all guestbooks ([23ee408](https://github.com/NFNEEK/svglabs/commit/23ee4086a8c2166bdd6fe82b1cb50cc286793bb3))
* jest fail on console error and warn ([2dd92f2](https://github.com/NFNEEK/svglabs/commit/2dd92f2db19df25210f0aa6eb8b9c44136a16ab7))
* link in BaseTemplate replaced margin with gap ([28b6ff2](https://github.com/NFNEEK/svglabs/commit/28b6ff24577b5d4338a7da068e06070c7f50f195))
* make guestbook editable ([8ec1406](https://github.com/NFNEEK/svglabs/commit/8ec14066a966c76b02bf5552ec2f4f348048a45c))
* make guestbook endpoint avaiable to signed out users ([10b4d81](https://github.com/NFNEEK/svglabs/commit/10b4d814d477e3475569537b1ef01a86b68c9a43))
* make it easier to try edge runtime in the app router ([3f5fd58](https://github.com/NFNEEK/svglabs/commit/3f5fd58d0980fdd35860d31d29b8f18e9c93b53f))
* make the index page of the boilerplate cleaner ([f3a3f9b](https://github.com/NFNEEK/svglabs/commit/f3a3f9b306bfaed85058d59cd15e62db158468ca))
* make updatedAt working when the user update a message and rename the attribute to updatedAt ([4032bc0](https://github.com/NFNEEK/svglabs/commit/4032bc0123660c20a72aa52ed611ea1f150e54af))
* migreate the index page from Page Rotuer to App Router ([fd3e82c](https://github.com/NFNEEK/svglabs/commit/fd3e82c2ff837951277a8300fd95f15294b9290a))
* move messages folder to locales ([305e385](https://github.com/NFNEEK/svglabs/commit/305e38504939008ecfbbd3bfb6deaf052e57eae7))
* prod environement use the same method to migrate ([f6cfe7f](https://github.com/NFNEEK/svglabs/commit/f6cfe7fa7583621c9161aa478f1d958d5c93c083))
* redirect to dashboard when the user is signed in for sign up and sign in page ([629a033](https://github.com/NFNEEK/svglabs/commit/629a03363af310e5411fea4cb554b53e72701e7d))
* release a new version for Next.js 14 and update README file ([4be2485](https://github.com/NFNEEK/svglabs/commit/4be24850b75b9ca896e9e5546b8357745b128398))
* reload guestbook page when deployed on production ([c2e91b2](https://github.com/NFNEEK/svglabs/commit/c2e91b2df944b0659d1768d2a7cc54a494d7d5c1))
* remove all Cypress related files and configurations ([9fe8271](https://github.com/NFNEEK/svglabs/commit/9fe8271e667b819910702803f5489e99766fe9ff))
* remove basePath in Next.js configuration ([7f9a0e6](https://github.com/NFNEEK/svglabs/commit/7f9a0e6ed42aec7d9ec500531b7f519dc11a5ec9))
* remove eslint rule customization in VSCode and use min(1) instead of nonempty (deprecated) ([9982a2d](https://github.com/NFNEEK/svglabs/commit/9982a2d94fe7854eefaa754e9f41cf4735a81c86))
* remove import React when it's not needed ([a7082d3](https://github.com/NFNEEK/svglabs/commit/a7082d3492d9a426218829f86554b2aeda9da8fd))
* remove MIGRATE_DB which not needed anymore with process.env.NODE_ENV ([3fe81ae](https://github.com/NFNEEK/svglabs/commit/3fe81ae98440b33ce18cee80265fdaa54e242184))
* remove no-img-element and use Next.js built-in <Image component ([383e3a3](https://github.com/NFNEEK/svglabs/commit/383e3a38b98d92d59184275864888e9693a1cff7))
* remove notnull in schema.ts ([10f4943](https://github.com/NFNEEK/svglabs/commit/10f49434999ba0a884a72e640c67dc955bf7eedd))
* remove Page router and migrate about page to App Router ([3965cbf](https://github.com/NFNEEK/svglabs/commit/3965cbf89a67a64272b895809a31791ccf383b57))
* remove stories in the coverage from Jest ([d502869](https://github.com/NFNEEK/svglabs/commit/d502869a08a0b1d9025a4ce582651c5353f29d59))
* remove warning for no extreneous deps in stories ([b243d44](https://github.com/NFNEEK/svglabs/commit/b243d441e4b75566e16f5fa64d26900267eb89f5))
* rename custom SignOutButton to LogOutButton to avoid confusion with Clerk SignOutButton ([183301b](https://github.com/NFNEEK/svglabs/commit/183301b5e87bfa4479727c295e83b45b923454a0))
* rename from email to username ([52ab0e4](https://github.com/NFNEEK/svglabs/commit/52ab0e4f86b20ace52cbb6ce421f85357c0dfa6e))
* rename from master to main ([10920ec](https://github.com/NFNEEK/svglabs/commit/10920ece4892ca73639388116af59fdd3e077d5f))
* replace dotenv/config by dotenv-cli in db:studio NPM scripts ([f7f8743](https://github.com/NFNEEK/svglabs/commit/f7f87435a984fa9d0407a7602d1ef38563c5e8d0))
* replace new-router page by guestbook ([efc84e6](https://github.com/NFNEEK/svglabs/commit/efc84e607d23981dba07b931ff078776aa9693b5))
* replace with a working URL for the database to avoid timeout ([fecd8a5](https://github.com/NFNEEK/svglabs/commit/fecd8a5d66934af774fde12759f8079cabfb382b))
* resolve conflict between airbnb-hook and next/core-web-vitals about react hooks ([5e0be4f](https://github.com/NFNEEK/svglabs/commit/5e0be4fd8c2f9acd895f0b9ce373af7d782d44df))
* run github release only on completed CI workflow ([dd4de76](https://github.com/NFNEEK/svglabs/commit/dd4de76b6ea013190a6ea18d69eb3764e1b915f9))
* translate text in dashboard layout ([8119f1d](https://github.com/NFNEEK/svglabs/commit/8119f1db63853f83710a6cc1f3135b45bc209809))
* unified e2e tests for Checkly and playwright ([afa53f5](https://github.com/NFNEEK/svglabs/commit/afa53f56b51f9a537131ceb046f90ea59c17dd71))
* update dependencies to the latest version ([b7609de](https://github.com/NFNEEK/svglabs/commit/b7609dea1c8bd49f6ac05439740ea78894cd4a79))
* update dotenv path to .env, the file was renamed ([bd9b2c9](https://github.com/NFNEEK/svglabs/commit/bd9b2c9efd12a0b54125ac352c43aab9d31c7c99))
* update footer message and comment ([4f74176](https://github.com/NFNEEK/svglabs/commit/4f74176b05528666fd8b92a8becdc7e3c2f0db4a))
* update next.js to version 13.5 ([aa43f14](https://github.com/NFNEEK/svglabs/commit/aa43f14bea16fcb4fd786d9fe74ae37bf29b5b5f))
* update package-lock.json to fix CI ([1fff7ef](https://github.com/NFNEEK/svglabs/commit/1fff7efe7295a9ee750b9f05af1a670db7bda733))
* update storybook to the latest version and install playwright ([2079a34](https://github.com/NFNEEK/svglabs/commit/2079a347bbbd08d2ffbc4ea96995eaaf66602373))
* update test for new router page ([b695666](https://github.com/NFNEEK/svglabs/commit/b695666fd41c9ddf1886e9b5e3c7cc43b616820c))
* update to Next.js 14.1 ([5dab52d](https://github.com/NFNEEK/svglabs/commit/5dab52d58648a12b5779f04d642ad4b2010931b0))
* update to the latest dependencies version ([d93fd83](https://github.com/NFNEEK/svglabs/commit/d93fd83b6ab93360ddd8489afc8cfb05603e504c))
* update TypeScript to 4.9.x ([471dc70](https://github.com/NFNEEK/svglabs/commit/471dc70306c69ecb524af40aa76403daa83597e2))
* use custom SignOutButton to apply custom CSS styles, unified with other nav links ([35094bf](https://github.com/NFNEEK/svglabs/commit/35094bf038f0eae6e7e2d77238840c97cc7adabe))
* use default airbnb instead of the base version ([5c05116](https://github.com/NFNEEK/svglabs/commit/5c05116fb777aee09c1af7df6694e54403eaaccb))
* use eslintrc.json and give release.yml permission in GitHub Actions ([a329518](https://github.com/NFNEEK/svglabs/commit/a32951811e157696ab915eebd6b71b09f49ccb83))
* use local SQLite file ([fe52801](https://github.com/NFNEEK/svglabs/commit/fe528010cf2d867fcbbc53156ae7fa6c862a88f4))
* use Next.js custom TypeScript plugin ([915e193](https://github.com/NFNEEK/svglabs/commit/915e193f8037d36e9779fe7464a4d6c1685b3a94))
* use target URl instead of baseURL for checkly ([4fd61ed](https://github.com/NFNEEK/svglabs/commit/4fd61edc77e1ef0d457cb829a89545f7dab47210))
* validate t3 env on build ([6d448ed](https://github.com/NFNEEK/svglabs/commit/6d448ed0fdea51952c8bfeaf4ce948cf9365675c))


### Reverts

* add back NEXT_PUBLIC_CLERK_SIGN_IN_URL in the previous location ([16ae2ef](https://github.com/NFNEEK/svglabs/commit/16ae2ef3a7b2800a3ac4d847bb7afa70743ee805))
* add back process.env.NODE_ENV check in README file for migrate ([853f3dc](https://github.com/NFNEEK/svglabs/commit/853f3dc4cbade618902b382023fe6a6a8e947082))
* add back style for a tag link ([c12a7bd](https://github.com/NFNEEK/svglabs/commit/c12a7bd400c875a115eefe2a9921db9e36bf644d))
* add support for all Node.js 14+, too restrictive with only Node.js 18+ ([4e27540](https://github.com/NFNEEK/svglabs/commit/4e27540f638d4767fb60b612519669ad6bf69367))
* change related to running playwright with next start ([1a2d0b6](https://github.com/NFNEEK/svglabs/commit/1a2d0b6473e6e7b4965c7df353d39645a8688273))
* change related to running playwright with next start ([e9e0c17](https://github.com/NFNEEK/svglabs/commit/e9e0c1790a8e76b51ee8a0b1012cc3492349bd1b))
* downgrade semantic-release version to 19 ([26d5a6e](https://github.com/NFNEEK/svglabs/commit/26d5a6ebe2fc4fe59fef40779e132ccf1f31c09f))
* only run migration in development, if it run in production, it also run during the build ([c94a600](https://github.com/NFNEEK/svglabs/commit/c94a6007b20f71fe10b10c76a05659364ee920ff))
* remove storybook addon-styling which is not needed ([e863fed](https://github.com/NFNEEK/svglabs/commit/e863fedcbc5a1aaf808c295d80f8de95b6abd1f7))
* the failing test in Navigation spec ([28996f5](https://github.com/NFNEEK/svglabs/commit/28996f59d2f02562761609348000d55776365f7e))
* update dependencies and remove commitzen ([d136e02](https://github.com/NFNEEK/svglabs/commit/d136e02678c5dac2e8d64c388bcfe6d48f9e2ad9))
* use older TypeScript to avoid e2e compilation with sourcemap ([6377d2f](https://github.com/NFNEEK/svglabs/commit/6377d2f2efc71384fba236427086b4e75f189328))
* use percy/cli 1.27.4 instead of 1.27.5, impossible to upload snapshort with 1.27.5 ([73f8a0b](https://github.com/NFNEEK/svglabs/commit/73f8a0b0e9c69f83e5c5a2b51f52159fcc43c654))
